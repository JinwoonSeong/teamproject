            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="${ pageContext.request.contextPath }/banksystem/mypage">마이페이지</a></li>
            ...
            <div class="container px-5 my-5">
                <div class="row gx-5">
                	...
                	<div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p>고객님 어서오세요!</p>
                        <a class="text-decoration-none" href="myaccount">
                            내 계좌 확인하러 가기!
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p>JW은행과 동행해보세요!</p>
                        <a class="text-decoration-none" href="createaccount">
                            계좌 개설 하러가기!!
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <a class="text-decoration-none" href="savings">
                            적금 하러가기!!
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
